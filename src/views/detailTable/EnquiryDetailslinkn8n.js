...
const EnquiryDetails = () => {
  ...
  //Insert Setting
  const insertEnquiry = () => {
    if (!enquiryForms.first_name || !enquiryForms.email) {
      message('Please fill all required fields (Name, Email).', 'warning');
      return;
    }
    ...
    api
      ...
      .then((res) => {
        ...
        // Trigger the n8n workflow via your backend
        api
          .post('/enquiry/send-email', enquiryForms)
          .then(() => {
            message('Admin notification sent.', 'info');
          })
          .catch(() => {
            message('Failed to send admin notification.', 'error');
          });
              ...
              <FormGroup>
                ...
                <Row>
                  <Col md="12">
                    ...
                    <Input type="text" name="email" onChange={handleInputsenquiryForms} />
                  </Col>
                </Row>
              </FormGroup>
              <FormGroup>
