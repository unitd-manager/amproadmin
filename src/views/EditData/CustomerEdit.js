    ...
    <div style={formStyle}>
      ...
      {/* <ComponentCard style={{ marginBottom: '5px' }}>  */}
        ...
        <Nav tabs>
          ...
          <NavItem><NavLink className={classnames({ active: activeTab === '2' })} onClick={() => toggle('2')}>Customer Login Info</NavLink></NavItem>
        ...
        <TabContent activeTab={activeTab} style={{ overflow: 'visible' }}>
          ...
          {/* Other Tabs */}
          <TabPane tabId="2"><CustomerLogin handleInputs={handleInputs} contentDetails={contentDetails} /></TabPane>
          <TabPane tabId="3"><ContactPerson contactId={id} contentDetails={contentDetails} /></TabPane>
          <TabPane tabId="4"><CustomerShippingDetail contactId={id} contentDetails={contentDetails} /></TabPane>
          <TabPane tabId="5"><CustomerSalesmen customerId={id} contentDetails={contentDetails} /></TabPane>
