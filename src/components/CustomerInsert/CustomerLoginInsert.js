...
export default function CustomerLogininsert({ contentDetails, handleInputs }) {
      ...
      <Col md="6">
        ...
        <FormGroup>
          ...
          <Input
            ...
            value={contentDetails.email || ''} // Assuming 'user_name' is the field in contentDetails
            name="email"
          />
        </FormGroup>
      </Col>
