...
const GoodsReceiptInfoModal = ({ isOpen, toggle, selectedProduct }) => {
     GoodsReceiptInfoModal.propTypes = {
  ...
  const fetchPurchaseHistory = async () => {
    ...
    `/purchaseorder/getGoodsReceiptsByProductId`,
    {
...
export default GoodsReceiptInfoModal;
