...
const GoodsReturnProductInfoModal = ({ isOpen, toggle, selectedProduct }) => {
     GoodsReturnProductInfoModal.propTypes = {
  ...
  const fetchPurchaseHistory = async () => {
    ...
    `/purchaseorder/getGoodsReturnsByProductId`,
    {
...
export default GoodsReturnProductInfoModal;
