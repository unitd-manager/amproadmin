...
const PurchaseOrderProductInfoModal = ({ isOpen, toggle, selectedProduct }) => {
     PurchaseOrderProductInfoModal.propTypes = {
  ...
  const fetchPurchaseHistory = async () => {
    ...
    `/purchaseorder/getPurchaseOrdersByProductId`,
    {
...
export default PurchaseOrderProductInfoModal;
