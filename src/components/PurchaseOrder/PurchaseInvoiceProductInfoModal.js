...
const PurchaseInvoiceProductInfoModal = ({ isOpen, toggle, selectedProduct }) => {
     PurchaseInvoiceProductInfoModal.propTypes = {
  ...
  const fetchPurchaseHistory = async () => {
    ...
    `/purchaseorder/getPurchaseInvoicesByProductId`,
    {
...
export default PurchaseInvoiceProductInfoModal;
