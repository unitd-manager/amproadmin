...
const PurchaseDebitNoteProductInfoModal = ({ isOpen, toggle, selectedProduct }) => {
     PurchaseDebitNoteProductInfoModal.propTypes = {
  ...
  const fetchPurchaseHistory = async () => {
    ...
    `/purchaseorder/getPurchaseDebitNotesByProductId`,
    {
...
export default PurchaseDebitNoteProductInfoModal;
